...
![](https://github.com/AdamClarkStandke/GenerativeDeepLearning/blob/main/stuff%20(5).gif)

*Gif created using  [StableVideoDiffusion-Image2Video](https://github.com/AdamClarkStandke/GenerativeDeepLearning/blob/main/StableVideoDiffusion.ipynb) conditioned on synthetic generated image generated by Stable Diffusion using the text promt: "jet aircrat flying over jungle battlefield, detailed, 8k" and using the folloing hyperparameters: motion_bucket_id=130, min_guidance_scale=1.0, max_guidance_scale=3.0, noise_aug_strength=0.02, latents=None*
